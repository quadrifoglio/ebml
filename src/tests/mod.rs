...
fn elem_data_string() {
    ...
    assert_eq!(elem.data_utf8().unwrap(), "Wesh Poto".to_owned());
}
...
fn elem_data_unsigned_integer() {
    ...
    assert_eq!(elem.data_i64(), 424242 as i64);
}
...
fn elem_data_signed_integer() {
    ...
    assert_eq!(elem.data_i64(), -54874 as i64);
}
...
fn elem_data_float() {
    ...
    assert_eq!(elem.data_f32(), 42.222 as f32);
}
...
fn elem_data_double() {
    ...
    assert_eq!(elem.data_f64(), 55724.415732327 as f64);
}
